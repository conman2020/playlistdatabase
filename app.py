...
def show_all_playlists():
    ...
    return render_template("playlists.html", playlists=playlists, song=songs)
...
def show_playlist(playlist_id):
    ...
    return render_template("playlist.html", playlist=playlists, songs=song, form=form)
